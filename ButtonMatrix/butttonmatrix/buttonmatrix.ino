...
void setup()
{
  ...
  TCCR1A = 0;  
  TCCR1B = (1 << WGM12) | (1 << CS11) | (1 << CS10);  // делитель 64
  // 250к тиков в секунду, 250 тиков в миллисекунду
  OCR1A = (16000000 / 64 / 1000) * N; // за 10мс 2500 тиков
  TIMSK1 |= (1 << OCIE1A); // Прерывание срабатывает по истечению 2500 тиков
